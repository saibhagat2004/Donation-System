      ...
      <div className="w-full max-w-6xl mx-auto p-8 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-2xl">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-800 p-3 rounded-lg hover:from-yellow-500 hover:to-yellow-600 transition-all duration-200 font-semibold"
          >
            Continue as Guest
          </button>
